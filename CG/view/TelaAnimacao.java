...
public class TelaAnimacao extends JFrame {
	...
	/**
	 * Método responsável pela animação rotacionada Tem como parametro o numero de
	 * repetições
	 * 
	 * @param repeticoes
	 */
	...
	/**
	 * Tem como parâmetro o evento do botão adicionar
	 * 
	 * @param evt
	 */
	...
	/**
	 * Tem como parâmetro o evento do botão desenhar
	 * 
	 * @param evt
	 */
	...
	/**
	 * Método que desenha o objeto no plano
	 */
