...
public class TelaColuna extends JFrame {
	...
	public void initialize() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(getClass().getResource("imagens/logo.jpg")));
		internalFrame.setBounds(107, 22, 400, 300);
		...
		ok.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent event) {
				...
				CategoryDataset dataset = TelaColuna.createDataset();
				JFreeChart chart = TelaColuna.createBarChart(dataset);
